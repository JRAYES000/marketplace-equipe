...
| `linkedin-carrousel` | 1.0.4 | 15/09/2026 | « Fais-moi un carrousel » : compose un carrousel LinkedIn (PDF de 8 à 12 pages, 10 par défaut) pour Claude Agency ou Claude Partners à partir d'un sujet, avec ses propres garde-fous — nombre et longueur des diapos, règles d'écriture du texte du post (longueur, gras, emojis, accroche, chiffres sourcés, accents) — qui refusent tout contenu hors des règles plutôt que de le signaler seulement. `node etat.js` donne un point de situation avant de commencer. |
| `linkedin-commentaires` | 1.0.3 | 15/09/2026 | « Les commentaires du jour » : trouve des posts récents (moins de 4h en priorité) sous des comptes ciblés pour Claude Agency ou Claude Partners, et rédige un commentaire sur mesure dans l'un des quatre genres prévus — jamais une expérience inventée sans confirmation réelle, jamais plus de 5 par jour ni deux fois la même personne. `node etat.js` donne le quota du jour avant de commencer. |
| `linkedin-veille-virale` | 1.0.3 | 15/09/2026 | « Fais la veille du jour » : surveille des comptes LinkedIn suivis, calcule un vrai score d'engagement (réactions, commentaires, partages rapportés aux abonnés) et propose un post recyclé/inspiré pour Claude Agency ou Claude Partners — jamais deux fois le même jour, jamais plus de trois par semaine, vérifié contre un registre réel. `node etat.js` donne un point de situation avant de commencer. |
