...
**Paquet publié : `skills-equipe` 1.5.0.** La colonne *Version* indique la version du paquet dans laquelle chaque skill a été modifiée pour la dernière fois. Si le numéro affiché dans *Réglages → Plugins* est inférieur à 1.5.0, tu n'as pas la dernière version.
