...
**Paquet publié : `skills-equipe` 1.9.0.** Si le numéro affiché dans *Réglages → Plugins* est inférieur à 1.9.0, tu n'as pas la dernière version.
...
| `delegation-deepseek-openrouter` | 1.3.0 | 15/08/2026 | Fait faire les grosses tâches (résumés, traductions, gros volumes) par une IA moins chère. Tu économises tes messages Claude. À réserver au vrai volume : sur une tâche moyenne, baisser l'effort de réflexion de Claude coûte moins cher que l'aller-retour. |
