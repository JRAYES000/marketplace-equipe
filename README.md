...
| `linkedin-mise-en-forme` | 1.0.0 | 18/09/2026 | Règles de forme obligatoires pour tout post LinkedIn de Julien, sur les deux comptes : accroche formulée en question qui interpelle ou inquiète, au moins huit passages en gras (tous sans accent — le gras Unicode de LinkedIn n'a pas de lettre accentuée), trois sections portant chacune un titre en gras précédé d'un emoji, 3 à 6 emojis en tête de ligne, phrases de 20 mots maximum, corps entre 1 300 et 1 900 caractères. `scripts/verif-post.mjs verif <brouillon>` mesure les neuf critères et sort en code 1 si l'un échoue ; `scripts/verif-post.mjs gras "<segment>"` fabrique le gras et refuse un segment accentué. Se combine avec `contenu-linkedin`, qui dit quoi écrire. |
