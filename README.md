...
| `linkedin-veille-virale` | 1.0.2 | 15/09/2026 | « Fais la veille du jour » : surveille des comptes LinkedIn suivis, calcule un vrai score d'engagement (réactions, commentaires, partages rapportés aux abonnés) et propose un post recyclé/inspiré pour Claude Agency ou Claude Partners — jamais deux fois le même jour. `node etat.js` donne un point de situation avant de commencer. |
