...
**Paquet publié : `skills-equipe` 1.8.0.** Si le numéro affiché dans *Réglages → Plugins* est inférieur à 1.8.0, tu n'as pas la dernière version.
