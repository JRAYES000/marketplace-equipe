...
**Paquet publié : `skills-equipe` 1.7.0.** Si le numéro affiché dans *Réglages → Plugins* est inférieur à 1.7.0, tu n'as pas la dernière version.

Dans le tableau, *Version* est le numéro propre à chaque skill : il avance quand **cette** skill change, indépendamment des autres et du numéro du paquet. *Dernière mise à jour* est la date de ce changement-là. Quatre skills portent la même date parce qu'elles ont été recalibrées ensemble pour Opus 5.
