...
**Pour vérifier que ça a marché :** tu dois voir les huit skills dans tes capacités, chacune précédée du nom du paquet — `skills-equipe:phrase-magique`, `skills-equipe:fonce`, `skills-equipe:parallelisation-et-routage`, `skills-equipe:delegation-deepseek-openrouter`, `skills-equipe:linkedin-carrousel`, `skills-equipe:linkedin-commentaires`, `skills-equipe:linkedin-veille-virale`, `skills-equipe:linkedin-mise-en-forme`.
